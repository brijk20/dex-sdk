...
import { mainnet, rinkeby, arbitrumTestnetV3, sokol, xdai, matic, tavalanche, tmatic, tbinance } from 'dxswap-core/.contracts.json';
import { rinkeby as rinkeby$1, mainnet as mainnet$1, arbitrumTestnetV3 as arbitrumTestnetV3$1, sokol as sokol$1, xdai as xdai$1, matic as matic$1, tavalanche as tavalanche$1, tmatic as tmatic$1, tbinance as tbinance$1 } from 'dxswap-periphery/.contracts.json';
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = mainnet.factory, _FACTORY_ADDRESS[ChainId.RINKEBY] = rinkeby.factory, _FACTORY_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3.factory, _FACTORY_ADDRESS[ChainId.SOKOL] = sokol.factory, _FACTORY_ADDRESS[ChainId.XDAI] = xdai.factory, _FACTORY_ADDRESS[ChainId.MATIC] = matic.factory, _FACTORY_ADDRESS[ChainId.tAVALANCHE] = tavalanche.factory, _FACTORY_ADDRESS[ChainId.tMATIC] = tmatic.factory, _FACTORY_ADDRESS[ChainId.tBINANCE] = tbinance.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.RINKEBY] = rinkeby$1.router, _ROUTER_ADDRESS[ChainId.MAINNET] = mainnet$1.router, _ROUTER_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3$1.router, _ROUTER_ADDRESS[ChainId.SOKOL] = sokol$1.router, _ROUTER_ADDRESS[ChainId.XDAI] = xdai$1.router, _ROUTER_ADDRESS[ChainId.MATIC] = matic$1.router, _ROUTER_ADDRESS[ChainId.tAVALANCHE] = tavalanche$1.router, _ROUTER_ADDRESS[ChainId.tMATIC] = tmatic$1.router, _ROUTER_ADDRESS[ChainId.tBINANCE] = tbinance$1.router, _ROUTER_ADDRESS);
